...
public class BackgroundWorkerUsunKomentarz extends AsyncTask<String,Void,String> {
    ...
    String login;
    BackgroundWorkerUsunKomentarz(Context context)
    {
        contextt=context;
    ...
    protected String doInBackground(String... params) {
        String typ= params[0];
        String login_url="http://arduinopwsz.ugu.pl/usun_komentarz.php";
        if(typ.equals("login"))
        {
            try
            {
    ...
    protected void onPostExecute(String result) {
        dialog.dismiss();
        Toast.makeText(contextt,R.string.komentarz_usuniety, Toast.LENGTH_SHORT).show();
