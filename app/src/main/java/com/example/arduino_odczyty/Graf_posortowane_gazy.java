...
public class Graf_posortowane_gazy extends AppCompatActivity {
    LineChart graf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graf_posortowane_gazy);
        typ = "login";
    ...
    {
        Intent intent=new Intent(Graf_posortowane_gazy.this,Wykresy_posortowane_wybierz.class);
