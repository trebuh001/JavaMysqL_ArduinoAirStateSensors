...
public class BackgroundWorkerEdytujKomentarz extends AsyncTask<String,Void,String> {
    ...
    String login;
    BackgroundWorkerEdytujKomentarz(Context context)
    {
        contextt=context;
    ...
    protected String doInBackground(String... params) {
        String typ= params[0];
        String login_url="http://arduinopwsz.ugu.pl/edytuj_komentarz.php";
        if(typ.equals("login"))
        {
            try
            {
    ...
    protected void onPostExecute(String result) {
        dialog.dismiss();
        Toast.makeText(contextt,R.string.komentarz_zedytowany, Toast.LENGTH_SHORT).show();
