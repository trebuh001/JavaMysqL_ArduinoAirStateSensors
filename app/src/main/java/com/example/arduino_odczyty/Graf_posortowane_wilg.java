...
public class Graf_posortowane_wilg extends AppCompatActivity {
    LineChart graf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graf_posortowane_wilg);
        typ = "login";
    ...
    {
        Intent intent=new Intent(Graf_posortowane_wilg.this,Wykresy_posortowane_wybierz.class);
