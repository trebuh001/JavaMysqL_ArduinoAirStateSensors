...
public class Kalendarz_druga_data extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener{
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute)
    {
        ...
        editor.putString("sortuj_druga_data", data);
        editor.commit();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kalendarz_druga_data);
    ...
    public void zapisz_druga_date(View v)
    {
    ...
    public void zatwierdz_date(View v)
    {
        if(data.equals(""))
        {
            Toast.makeText(getApplicationContext(),R.string.nie_wybrano_zadnej_daty,Toast.LENGTH_SHORT).show();
