...
public class Graf_posortowane extends AppCompatActivity {
    LineChart graf;
   ...
   ArrayList<String> data_lista;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graf_posortowane);
        typ = "login";
    ...
    {
        Intent intent=new Intent(Graf_posortowane.this,Wykresy_posortowane_wybierz.class);
