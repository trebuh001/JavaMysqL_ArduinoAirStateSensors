...
public class Graf_cisnienie extends AppCompatActivity {
    LineChart graf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graf_cisnienie);
    ...
    {
        Intent intent=new Intent(Graf_cisnienie.this,Wykresy_wybierz.class);
