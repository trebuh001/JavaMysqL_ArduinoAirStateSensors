...
public class Graf_wilg extends AppCompatActivity {
    LineChart graf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graf_wilg);
...
//                   cisnienie_lista.add(new Entry(j,Float.valueOf(odczyty2[j].cisnienie)));
    ...
    {
        Intent intent=new Intent(Graf_wilg.this,Wykresy_wybierz.class);
